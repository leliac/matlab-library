...
fc                 = 225.648e6; % Center frequency (Hz)
FrontEndSampleRate = 2.8e6;       % Samples per second
FrameLength        = 256*20;    % Frame length
AGC                = false;     % Enable tuner AGC
TunerGain          = 30;        % Tuner Gain (only used if AGC is set to 'false')
